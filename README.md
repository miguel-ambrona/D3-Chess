...
of standard rated games, which includes 3,821,355,240 games to date (October 2022).
...
This represents a total of 1,213,613,936 games (about 32% of all games) which have
been analyzed in about 117 hours of CPU time (348 μs per position on average).

Our analysis led to identifying a total of
[101,420](https://raw.githubusercontent.com/miguel-ambrona/D3-Chess/main/tests/unfair.txt)
...
when analyzing all the non-drawn timeouts from October 2022 (29,786,480 positions).
...
|       Average time per position |     264 μs    |     4.65 μs    |
|              Standard deviation |     483 μs    |     7.73 μs    |
|       Maximum time per position |     336 ms    |      523 us    |
| Unwinnable positions identified |  2208 (100%)  |  2208 (100%)   |
|            Total execution time |   2 h 11 min  |   2 min 18 s   |
